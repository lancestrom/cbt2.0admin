...
class Dashboard_otkp extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $isi['siswaOTKP'] = $this->Model_siswa->countSiswaMPLB();
    ...
    public function siswa_mplb_moodle()
    {
        $this->Model_keamanan->getKeamanan();
        $isi['siswa'] = $this->Model_siswa->dataSiswaMoodleOTKP();

        $isi2['title'] = 'CBT | Administrator';
        $isi['content'] = 'OTKP/tampilan_siswa_mplb_moodle';
        $this->load->view('templates/header', $isi2);
        $this->load->view('OTKP/tampilan_dashboard', $isi);
        $this->load->view('templates/footer');
    }
    ...
    public function proses_block_user()
    {
        ...
        redirect('Dashboard_otkp/siswa_mplb_moodle');
    }

    public function siswa_mplb_moodle_block()
    {
        $this->Model_keamanan->getKeamanan();
        $isi['siswa'] = $this->Model_siswa->dataSiswaMoodleBlockOTKP();

        $isi2['title'] = 'CBT | Administrator';
        $isi['content'] = 'OTKP/tampilan_siswa_mplb_moodle_block';
        $this->load->view('templates/header', $isi2);
        $this->load->view('OTKP/tampilan_dashboard', $isi);
        $this->load->view('templates/footer');
    }
    ...
    public function proses_unblock_user()
    {
        ...
        $this->db->where('id', $id);
        $this->db->update('cbt_user', $data);
        redirect('Dashboard_otkp/siswa_mplb_moodle_block');
    }

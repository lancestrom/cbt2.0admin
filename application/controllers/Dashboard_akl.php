...
class Dashboard_akl extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $isi['siswaAKL'] = $this->Model_siswa->countSiswaAKL();
    ...
    public function siswa_akl_moodle()
    {
        $this->Model_keamanan->getKeamanan();
        $isi['siswa'] = $this->Model_siswa->dataSiswaMoodleAKL();

        $isi2['title'] = 'CBT | Administrator';
        $isi['content'] = 'AKL/tampilan_siswa_akl_moodle';
        $this->load->view('templates/header', $isi2);
        $this->load->view('AKL/tampilan_dashboard', $isi);
        $this->load->view('templates/footer');
    }

    public function siswa_akl_moodle_block()
    {
        $this->Model_keamanan->getKeamanan();
        $isi['siswa'] = $this->Model_siswa->dataSiswaMoodleBlockAKL();

        $isi2['title'] = 'CBT | Administrator';
        $isi['content'] = 'AKL/tampilan_siswa_akl_moodle_block';
        $this->load->view('templates/header', $isi2);
        $this->load->view('AKL/tampilan_dashboard', $isi);
        $this->load->view('templates/footer');
    }
    ...
    public function proses_block_user()
    {
        ...
        redirect('Dashboard_akl/siswa_akl_moodle');
    }
    ...
    public function proses_unblock_user()
    {
        ...
        $this->db->where('id', $id);
        $this->db->update('cbt_user', $data);
        redirect('Dashboard_akl/siswa_akl_moodle_block');
    }

...
<div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
        ...
        <!-- Sidebar - Brand -->
        <a class="sidebar-brand d-flex align-items-center justify-content-center" href="<?= base_url() ?>Dashboard_otkp">
            <div class="sidebar-brand-text mx-3">CBT 2.0 <br> ADMIN MPLB</div>
        </a>
        ...
        <li class="nav-item">
            ...
            <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                <div class="bg-white py-2 collapse-inner rounded">
                    ...
                    <a class="collapse-item" href="<?= base_url() ?>Dashboard_otkp/mata_pelajaran_otkp">Master Mata Pelajaran</a>
                </div>
            </div>
        </li>
        <li class="nav-item">
            <a class="nav-link" href="<?= base_url() ?>Dashboard_otkp/siswa_otkp">
        ...
        <li class="nav-item">
            ...
            <div id="collapsePages" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
                <div class="bg-white py-2 collapse-inner rounded">
                    <a class="collapse-item" href="<?= base_url() ?>Dashboard_otkp/status_peserta_otkp">Status Peserta</a>
                    <a class="collapse-item" href="<?= base_url() ?>Dashboard_otkp/filter_status_peserta">Filter Status Peserta</a>
                    <a class="collapse-item" href="<?= base_url() ?>Dashboard_otkp/rekap_nilai_otkp">Cetak Daftar Nilai</a>
                </div>
            </div>
        </li>

...
<div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
        ...
        <a class="sidebar-brand d-flex align-items-center justify-content-center" href="<?= base_url() ?>Dashboard_tkj">
            <div class="sidebar-brand-text mx-3">CBT 2.0 <br> ADMIN TJKT</div>
        </a>
        ...
        <li class="nav-item">
            ...
            <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                <div class="bg-white py-2 collapse-inner rounded">
                    ...
                    <a class="collapse-item" href="<?= base_url() ?>Dashboard_tkj/mata_pelajaran_tkj">Master Mata Pelajaran</a>
                </div>
            </div>
        </li>
        <li class="nav-item">
        ...
        <li class="nav-item">
            ...
            <div id="collapsePages" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
                <div class="bg-white py-2 collapse-inner rounded">
                    <a class="collapse-item" href="<?= base_url() ?>Dashboard_tkj/status_peserta_tkj">Status Peserta</a>
                    <a class="collapse-item" href="<?= base_url() ?>Dashboard_tkj/filter_status_peserta">Filter Status Peserta</a>
                    <a class="collapse-item" href="<?= base_url() ?>Dashboard_tkj/rekap_nilai_tkj">Cetak Daftar Nilai</a>
                </div>
            </div>
        </li>

...
<div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
        ...
        <a class="sidebar-brand d-flex align-items-center justify-content-center" href="<?= base_url() ?>Dashboard_bdp">
            <div class="sidebar-brand-text mx-3">CBT 2.0 <br> ADMIN PM</div>
        </a>
        ...
        <li class="nav-item">
            <a class="nav-link" href="<?= base_url() ?>Dashboard_bdp/siswa_bdp_moodle">
                <i class="fas fa-user-graduate"></i>
                <span>Peserta Moodle</span></a>
        </li>

        <li class="nav-item">
            <a class="nav-link" href="<?= base_url() ?>Dashboard_bdp/siswa_bdp_moodle_block">
                <i class="fas fa-user-graduate"></i>
        ...
        <li class="nav-item">
            ...
            <div id="collapsePages" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
                <div class="bg-white py-2 collapse-inner rounded">
                    ...
                    <a class="collapse-item" href="<?= base_url() ?>Dashboard_bdp/filter_status_peserta">Filter Status Peserta</a>
